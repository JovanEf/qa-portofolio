Feature: Login Page
    ...
    Scenario: Failed login with invalid credentials
        ...
        And user clicks the Login button
        Then user should sees error message "Epic sadface: Username and password do not match any user in this service" on Login page
    ...
    Scenario: Locked out user cannot login
        ...
        And user enters password "secret_sauce"
        And user clicks the Login button
        Then user should sees error message "Epic sadface: Sorry, this user has been locked out." on Login page
        And user should remain on the Login page
    ...
    Scenario: Login with empty username
        ...
        And user enters password "secret_sauce"
        And user clicks the Login button
        Then user should sees error message "Epic sadface: Username is required" on Login page
        And user should remain on the Login page
    ...
    Scenario: Login with empty password
        ...
        And user clicks the Login button
        Then user should sees error message "Epic sadface: Password is required" on Login page
        And user should remain on the Login page
